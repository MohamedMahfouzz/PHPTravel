...
public class RegisterNeg {
	...
	@Test(priority=0)
	public void RegistrationNegInfo() {
		...
		try {
			...
			PW = RandomStringUtils.random(5, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz");
			...
			ConfirmPassword.sendKeys(PW.substring(0, PW.length()/2));
